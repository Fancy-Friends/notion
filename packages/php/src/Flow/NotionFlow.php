 ...
 */
/**
 * Every Notion node executor — the PHP twin of `NOTION_RUNNABLE_KINDS` in
 * @particle-academy/notion-js.
 *
 * Each class declares its kind in a `#[FlowNode]` attribute. Two ways onto a
 * host:
 *
 * - `NotionFlow::register($kinds, $executors)` — one call, no directory scan.
